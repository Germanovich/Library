        ...
        <nav>
            <ul class="pagination justify-content-center">
                <c:if test="${currentPage != 1}">
                    <li class="page-item">
                        <a class="page-link"
                           href="library?command=BOOKS_BY_AUTHOR&search_text=${search_text}&recordsPerPage=${recordsPerPage}&currentPage=${currentPage-1}">
                ...
                <c:forEach begin="1" end="${noOfPages}" var="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link"
                                   href="library?command=BOOKS_BY_AUTHOR&search_text=${search_text}&recordsPerPage=${recordsPerPage}&currentPage=${i}">${i}
                                </a>
                            </li>
                        </c:otherwise>
                    </c:choose>
