...
public class BooksByAuthorCommand implements ActionCommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (session != null) {
            ...
            page = ConfigurationManager.getProperty("path.page.books.by.author");
        }
        return page;
    }
    ...
    private void initBookTable(HttpServletRequest request) {
        ...
        String author = request.getParameter("search_text");

        List<Book> bookList = bookService.getBookListByAuthor(currentPage, author);
        request.setAttribute("books", bookList);
        request.setAttribute("search_text", author);

        int rows = bookService.getNumberOfRowsByAuthor(author);
